...
export const adafruit1911AlphanumbericDisplayStemmaQt: CatalogPart = {
  "id": "1911-alphanumberic-display-stemma-qt",
  "name": "1911 Alphanumberic Display STEMMA QT",
  "category": "ui",
  "description": "1911 Alphanumberic Display STEMMA QT imported from the CAD part labeler with labeled mounting features for enclosure generation.",
  "tags": [
    "adafruit",
    "stemma",
    "qwiic-compatible",
  ...
  "attachmentPoints": [
    ...
    },
    {
      ...
      "diameterMm": 2,
      "notes": "Selected center from #8767; radius 1 mm."
    },
    {
      "id": "front-left-mount",
