...
export const adafruit4469Mlx90640Stemma: CatalogPart = {
  "id": "4469-mlx90640-stemma",
  "name": "4469 MLX90640 Stemma",
  "category": "sensor",
  "description": "4469 MLX90640 Stemma imported from the CAD part labeler with labeled mounting features for enclosure generation.",
  "tags": [
    "adafruit",
    "stemma",
    "qwiic-compatible",
  ...
  "attachmentPoints": [
    {
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #3810; radius 1.25 mm."
    },
    {
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #3808; radius 1.25 mm."
    },
    {
      "id": "back-left-mount",
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #3838; radius 1.25 mm."
    },
    {
      "id": "back-right-mount",
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #3840; radius 1.25 mm."
    }
  ],
  "electricalPorts": [
    {
