...
export const adafruit5295NeosliderStemma: CatalogPart = {
  "id": "5295-neoslider-stemma",
  "name": "5295 NeoSlider Stemma",
  "category": "ui",
  "description": "5295 NeoSlider Stemma imported from the CAD part labeler with labeled mounting features for enclosure generation.",
  "tags": [
    "adafruit",
    "stemma",
    "qwiic-compatible",
  ...
  "attachmentPoints": [
    {
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #7578; radius 1.25 mm."
    },
    {
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #7580; radius 1.25 mm."
    },
    {
      "id": "back-left-mount",
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #7498; radius 1.25 mm."
    },
    {
      "id": "back-right-mount",
      ...
      "diameterMm": 2.5,
      "notes": "Selected center from #7496; radius 1.25 mm."
    }
  ],
  "electricalPorts": [
    {
